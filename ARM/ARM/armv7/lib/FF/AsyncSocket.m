...
///////////
typedef void (*GetBuffDataInfos)(int v1,void * pinfo);

//////////////
static void MyDoObjcCallback(int v1,void * pinfo);
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#pragma mark -
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void MyDoObjcCallback(int v1,void * pinfo){
    
    
	//[theSocket doCFReadStreamCallback:type forStream:stream];
	NSLog(@"succ to call 43534534522222222");
    
    
}


void ExpectFunction(id sel,GetBuffDataInfos pfunptr){
    
    NSLog(@"succ to call 1111111");
    
    //    CmsMainViewController * ccc=(__bridge CmsMainViewController*)pInfo;
    //    
    //    [ccc DoObjcCallback:100 :NULL];
    
    //[sel  DoObjcCallback:100 :NULL];
}


-(void)callMyCallbaclDemo{
    
    ExpectFunction(self, (GetBuffDataInfos)MyDoObjcCallback);
